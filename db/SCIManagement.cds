...
define entity SCI_TP0010 : cuid, managed {
    ...
    IF_DESC              : String(100);
    STATUS_CD            : Association to SCI_MST0010 not null;
    UNSUED_DT            : Timestamp;
    ...
    TG_IFTYPE_CD         : Association to SCI_MST0010 not null;
    RFC_NM               : String(50);
    ENTERPRSIESERVICE_NM : String(50);
    WEBSERVICE_NM        : String(50);
    WEBBINDING_NM        : String(50);
    EXECUTION_CD         : Association to SCI_MST0010 not null;
    BATCHCYCLE_CD        : Association to SCI_MST0010;
...
define entity SCI_MST0010_HIST : cuid, managed {
    MST0010    : Association to SCI_MST0010;
    CAT01      : String(20) not null;
    CAT02      : String(20);
    CAT03      : String(20);
    CODE       : String(20) not null;
